...
### III. 微服务架构 (Microservices Architecture)
系统采用微服务架构，各服务独立部署和扩展，通过明确定义的接口通信。

**规则**：
- v1.0 MVP 可采用单体架构以加快交付，服务边界须清晰划定（项目/任务/通知模块）
- 后续扩展时须遵循微服务原则拆分
- 服务间通信使用RESTful API
- 每个服务拥有独立的数据库（v2.0+目标）

**理由**：微服务架构支持独立部署、扩展和技术栈灵活性，是现代云原生应用的基础。小团队(5人)在v1.0阶段不需要服务拆分带来的运维复杂度。
